    ...
    <div class="demo-drawer__content">
      <div class="drawer_content">
        <div class="approver_content">
          ...
          <el-button type="primary" @click="addRoleApprover" v-if="approverConfig.settype === 1">添加/修改角色
          </el-button>
        ...
        <div class="approver_self_select" v-show="approverConfig.settype === 4">
          ...
          <template v-if="approverConfig.selectRange === 2||approverConfig.selectRange === 3">
            <el-button type="primary" @click="addApprover" v-if="approverConfig.selectRange === 2">添加/修改成员
            </el-button>
        ...
        <div class="approver_some" v-if="
                     (approverConfig.settype === 1 && (approverConfig.nodeUserList.length>1 || approverConfig?.nodeUserList[0]?.type===2))
